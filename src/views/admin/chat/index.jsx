  ...
  return (
    <div>
      ...
      <div>
        ...
        <h2 className="text-center text-white dark:text-gray-600 text-2xl mt-6 font-extrabold">Messages with selected User:</h2>
        <ul>
  {messages.map((message, index) => (
    <li
      key={index}
      className={` text-xl text-${message.sender === "You" ? "white" : "white"} ${message.sender === "You" ? "text-right" : ""} rounded-2xl w-66 `}
    >
